...
import net.umpay.mailbill.api.model.cgbbank.CgbBillView;
 ...
 */
@Service
public class CmbOldConvertImpl implements IConvert{

	@Override
	public int getBillType() {
		return MailBillTypeConstants.BILL_TYPE_OLD_CMB;
	}

	@Override
	public CgbBillView convertEntityAndView(
		...
		CgbBillView cmbOldBillView = new CgbBillView();
		...
		cmbOldBillView.setBillView(billView);
		cmbOldBillView.setBalanceBillViews(balanceBillViews);
		cmbOldBillView.setMonthBillViews(monthBillViews);
		cmbOldBillView.setIntegrationBillView(integrationBillView);
		return cmbOldBillView;
	}
