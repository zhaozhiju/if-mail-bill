...
import net.umpay.mailbill.api.model.beijing.BeiJingBillView;
 ...
 */
@Service
public class BeiJingConvertImpl implements IConvert{

	@Override
	public int getBillType() {
		return MailBillTypeConstants.BILL_TYPE_BEIJING;
	}

	@Override
	public BeiJingBillView convertEntityAndView(
		...
		BeiJingBillView beiJingBillView = new BeiJingBillView();
		...
		int billDate = billCycleInfoEntity.getBillDate();
		if (0 != billDate){
		...
		beiJingBillView.setBillView(billView);
		beiJingBillView.setBalanceBillViews(balanceBillViews);
		beiJingBillView.setMonthBillViews(monthBillViews);
		beiJingBillView.setIntegrationBillView(integrationBillView);
		return beiJingBillView;
	}
