...
import net.umpay.mailbill.api.model.cibbank.CibBillView;
 ...
 */
@Service
public class CibConvertImpl implements IConvert{

	@Override
	public int getBillType() {
		return MailBillTypeConstants.BILL_TYPE_CIB;
	}

	@Override
	public CibBillView convertEntityAndView(
		...
		CibBillView cibBillView = new CibBillView();
		...
		cibBillView.setBillView(billView);
		cibBillView.setBalanceBillViews(balanceBillViews);
		cibBillView.setMonthBillViews(monthBillViews);
		cibBillView.setIntegrationBillView(integrationBillView);
		return cibBillView;
	}
