...
import net.umpay.mailbill.api.model.citicbank.CiticBillView;
 ...
 */
@Service
public class CiticConvertImpl implements IConvert{

	@Override
	public int getBillType() {
		return MailBillTypeConstants.BILL_TYPE_CITIC;
	}

	@Override
	public CiticBillView convertEntityAndView(
		...
		CiticBillView citicBillView = new CiticBillView();
		...
		citicBillView.setBillView(billView);
		citicBillView.setBalanceBillViews(balanceBillViews);
		citicBillView.setMonthBillViews(monthBillViews);
		citicBillView.setIntegrationBillView(integrationBillView);
		return citicBillView;
	}
