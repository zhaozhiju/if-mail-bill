...
import net.umpay.mailbill.api.model.cmbbank.CmbBillView;
 ...
 */
@Service
public class CmbConvertImpl implements IConvert{

	@Override
	public int getBillType() {
		return MailBillTypeConstants.BILL_TYPE_CMB;
	}

	@Override
	public CmbBillView convertEntityAndView(
		...
		CmbBillView cmbBillView = new CmbBillView();
		...
		cmbBillView.setBillView(billView);
		cmbBillView.setBalanceBillViews(balanceBillViews);
		cmbBillView.setMonthBillViews(monthBillViews);
		cmbBillView.setIntegrationBillView(integrationBillView);
		return cmbBillView;
	}
