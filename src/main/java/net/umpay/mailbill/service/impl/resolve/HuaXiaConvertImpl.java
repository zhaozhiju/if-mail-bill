...
import net.umpay.mailbill.api.model.huaxiabank.HuaXiaBillView;
 ...
 */
@Service
public class HuaXiaConvertImpl implements IConvert{

	@Override
	public int getBillType() {
		return MailBillTypeConstants.BILL_TYPE_HUAXIA;
	}

	@Override
	public HuaXiaBillView convertEntityAndView(
		...
		HuaXiaBillView huaXiaBillView = new HuaXiaBillView();
		...
		// 美元积分
		long usdIntegration = billCycleInfoEntity.getUsaIntegration();
		billView.setUsaIntegration(Long.toString(usdIntegration));
		...
		huaXiaBillView.setBillView(billView);
		huaXiaBillView.setBalanceBillViews(balanceBillViews);
		huaXiaBillView.setMonthBillViews(monthBillViews);
		huaXiaBillView.setIntegrationBillView(integrationBillView);
		return huaXiaBillView;
	}
