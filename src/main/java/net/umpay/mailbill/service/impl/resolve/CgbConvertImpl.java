 ...
 */
@Service
public class CgbConvertImpl implements IConvert{

	@Override
	public int getBillType() {
		return MailBillTypeConstants.BILL_TYPE_CGB;
	}
	...
	public CgbBillView convertEntityAndView(
		...
		CgbBillView cgbBillView = new CgbBillView();
		...
		cgbBillView.setBillView(billView);
		cgbBillView.setBalanceBillViews(balanceBillViews);
		cgbBillView.setMonthBillViews(monthBillViews);
		cgbBillView.setIntegrationBillView(integrationBillView);
		return cgbBillView;
	}
