...
import net.umpay.mailbill.api.model.bocommbank.BocommVisaView;
 ...
 */
@Service
public class BocommVisaConvertImpl implements IConvert{

	@Override
	public int getBillType() {
		return MailBillTypeConstants.BILL_TYPE_BOCOMMVISA;
	}

	@Override
	public BocommVisaView convertEntityAndView(
		...
		BocommVisaView bocommVisaView = new BocommVisaView();
		...
		bocommVisaView.setBillView(billView);
		bocommVisaView.setBalanceBillViews(balanceBillViews);
		bocommVisaView.setMonthBillViews(monthBillViews);
		bocommVisaView.setIntegrationBillView(integrationBillView);
		return bocommVisaView;
	}
