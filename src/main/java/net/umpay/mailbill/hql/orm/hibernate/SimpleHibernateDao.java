...
import net.umpay.mailbill.hql.dao.BaseDao;
...
public abstract class SimpleHibernateDao<T, PK extends Serializable> implements BaseDao<T,PK>{
	...
	/**
         ...
         * @param criterions 数量可变的Criterion.
         */
        public List<Serializable> findSerial(final Criterion... criterions) {
                return createCriteria(criterions).list();
        }
	 ...
	 * @param criterions 数量可变的Criterion.
	 */
	public T findUniqueByCache(final Criterion... criterions) {
